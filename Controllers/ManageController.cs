...
namespace Core.Controllers
{
    ...
    public class ManageController : Controller
    {
        ...
        public IActionResult UpdateUser(Guid id)
        {
           ...
           ApplicationUser users =  _context.Users.Where(m =>m.UserName == User.Identity.Name).Single();
            if (users == null)
            {
                return NotFound();
            }
        ...
        public async Task<IActionResult> UpdateUser(string Id,[Bind("Id,FirstName,LastName,DeliveryAddress,StreetName,StreetNumber,PostalCode,City,Province,Country,DoB")] ApplicationUser model, string returnUrl = null)
        {
           ...
           // Model and User is good to update

           ViewData["ReturnUrl"] = returnUrl;
            if (ModelState.IsValid)
            {
                ApplicationUser userToUpdate = _context.Users.Where(ci => ci.Id == Id && ci.Id== UserId).First();
                if (userToUpdate != null){
                    userToUpdate.City = model.City;
                    userToUpdate.Country = model.Country;
                    userToUpdate.PostalCode = model.PostalCode;
                    userToUpdate.DeliveryAddress = model.DeliveryAddress;
