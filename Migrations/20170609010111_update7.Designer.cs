...
namespace Core.Migrations
{
    ...
    [Migration("20170609010111_update7")]
    partial class update7
    {
        protected override void BuildTargetModel(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity("Core.Models.Driver", b =>
                {
                    ...
                    b.Property<string>("UserAppUserId");
            ...
            modelBuilder.Entity("Core.Models.DeliveryArea", b =>
                {
                    b.HasOne("Core.Models.Driver")
                        .WithMany("DeliveryArea")
                        .HasForeignKey("DriverID");
                });

            modelBuilder.Entity("Core.Models.Driver", b =>
                {
                    b.HasOne("Core.Models.Franchise", "Franchise")
                        .WithMany()
                        .HasForeignKey("FranchiseId");

                    b.HasOne("Core.Models.Partner", "Partner")
                        .WithMany()
                        .HasForeignKey("PartnerId");

                    b.HasOne("Core.Models.ApplicationUser", "UserAppUser")
                        .WithMany()
